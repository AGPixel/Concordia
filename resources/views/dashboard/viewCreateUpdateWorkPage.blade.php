                        ...
                        <div class="card card-primary">
                            ...
                            <form id="quickForm">
                                <div class="card-body first-card-body">
                                    ...
                                    'arg_value' => $work->title ? $work->title : '',
                                    'arg_value_eng' => $work->title_eng ? $work->title_eng : ''
                                    ])
                                </div>
                                <div class="card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $work->description ? $work->description : '',
                                    'arg_value_eng' => $work->description_eng ? $work->description_eng : ''
                                    ])
                                </div>
                                <!-- 11111 -->
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    'arg_value' => $work->type_1 ? $work->type_1 : '',
                                    'arg_value_eng' => $work->type_1_eng ? $work->type_1_eng : ''
                                    ])
                                </div>
                                <div class="card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $work->title_1 ? $work->title_1 : '',
                                    'arg_value_eng' => $work->title_1_eng ? $work->title_1_eng : ''
                                    ])
                                </div>
                                <!-- 22222 -->
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    'arg_value' => $work->type_2 ? $work->type_2 : '',
                                    'arg_value_eng' => $work->type_2_eng ? $work->type_2_eng : ''
                                    ])
                                </div>
                                <div class="card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $work->title_2 ? $work->title_2 : '',
                                    'arg_value_eng' => $work->title_2_eng ? $work->title_2_eng : ''
                                    ])
                                </div>
                                <!-- 33333 -->
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    'arg_value' => $work->type_3 ? $work->type_3 : '',
                                    'arg_value_eng' => $work->type_3_eng ? $work->type_3_eng : ''
                                    ])
                                </div>
                                <div class="card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $work->title_3 ? $work->title_3 : '',
                                    'arg_value_eng' => $work->title_3_eng ? $work->title_3_eng : ''
                                    ])
                                </div>
                                <!-- 44444 -->
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    'arg_value' => $work->type_4 ? $work->type_4 : '',
                                    'arg_value_eng' => $work->type_4_eng ? $work->type_4_eng : ''
                                    ])
                                </div>
                                <div class="card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $work->title_4 ? $work->title_4 : '',
                                    'arg_value_eng' => $work->title_4_eng ? $work->title_4_eng : ''
                                    ])
                                </div>
                                <!-- 55555 -->
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    'arg_value' => $work->type_5 ? $work->type_5 : '',
                                    'arg_value_eng' => $work->type_5_eng ? $work->type_5_eng : ''
                                    ])
                                </div>
                                <div class="card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $work->title_5 ? $work->title_5 : '',
                                    'arg_value_eng' => $work->title_5_eng ? $work->title_5_eng : ''
                                    ])
                                </div>
                                <!-- 66666 -->
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    'arg_value' => $work->type_6 ? $work->type_6 : '',
                                    'arg_value_eng' => $work->type_6_eng ? $work->type_6_eng : ''
                                    ])
                                </div>
                                <div class="card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $work->title_6 ? $work->title_6 : '',
                                    'arg_value_eng' => $work->title_6_eng ? $work->title_6_eng : ''
                                    ])
                                </div>
                                <!-- 77777 -->
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    'arg_value' => $work->type_7 ? $work->type_7 : '',
                                    'arg_value_eng' => $work->type_7_eng ? $work->type_7_eng : ''
                                    ])
                                </div>
                                <div class="card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $work->title_7 ? $work->title_7 : '',
                                    'arg_value_eng' => $work->title_7_eng ? $work->title_7_eng : ''
                                    ])
                                </div>
