                        ...
                        <div class="card card-primary">
                            ...
                            <form id="quickForm">
                                <div class="card-body first-card-body">
                                    ...
                                    'arg_value' => $project->title_1 ? $project->title_1 : '',
                                    'arg_value_eng' => $project->title_1_eng ? $project->title_1_eng : ''
                                    ])
                                </div>
                                <div class="card-body first-card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $project->description_1 ? $project->description_1 : '',
                                    'arg_value_eng' => $project->description_1_eng ? $project->description_1_eng : ''
                                    ])
                                </div>
                                <div class="card-body first-card-body">
                                    ...
                                    'arg_value' => $project->url_project ? $project->url_project : '' ])
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        'arg_value' => $project->img_begin ? asset("../storage/$project->img_begin") : asset("/assets/img/sem_foto.png")])
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        'arg_value' => $project->img_1 ? asset("../storage/$project->img_1") : asset("/assets/img/sem_foto.png")])
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        'arg_value' => $project->img_2 ? asset("../storage/$project->img_2") : asset("/assets/img/sem_foto.png")])
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        'arg_value' => $project->img_3 ? asset("../storage/$project->img_3") : asset("/assets/img/sem_foto.png")])
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        'arg_value' => $project->img_4 ? asset("../storage/$project->img_4") : asset("/assets/img/sem_foto.png")])
                                    </div>
                                </div>
                                <div class="card-body first-card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $project->title_2 ? $project->title_2 : '',
                                    'arg_value_eng' => $project->title_2_eng ? $project->title_2_eng : ''
                                    ])
                                </div>
                                <div class="card-body first-card-body">
                                    @include('components.inputtextpteng',[
                                    ...
                                    'arg_value' => $project->description_2 ? $project->description_2 : '',
                                    'arg_value_eng' => $project->description_2_eng ? $project->description_2_eng : ''
                                    ])
                                </div>
