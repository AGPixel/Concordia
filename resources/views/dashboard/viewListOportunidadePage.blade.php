                    ...
                    <div class="col-md-12">
                        <div class="card-body first-card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="oportunidadeTitle" class="form-control" id="InputOportunidadeTitle" value="{{ isset($oportunidadeGeral->title) ? $oportunidadeGeral->title : '' }}">
                            </div>
                        </div>
                        <div class="card-body first-card-body">
                            <div class="form-group">
                                <label for="InputOportunidadeDescription">Description</label>
                                <input type="text" name="oportunidadeDescription" class="form-control" id="InputOportunidadeDescription" value="{{ isset($oportunidadeGeral->description) ? $oportunidadeGeral->description : '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 m-bot-1em">
                        <button type="button" class="btn btn-info btn-block btn-flat bt-width" onclick="saveOportunidadeGeral()">
