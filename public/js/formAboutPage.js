...
InputAboutImg1.addEventListener("change", load_image_about_preview, false);
...
InputAboutImg2.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutImg3.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutImg4.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutServiceImg1.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutServiceImg2.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutServiceImg3.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutServiceImg4.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutServiceImg5.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutServiceImg6.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutBrandsImg1.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutBrandsImg2.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutBrandsImg3.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
InputAboutBrandsImg4.addEventListener("change", load_image_about_preview, false);
async function load_image_about_preview() {
...
function saveAboutPage() {
    ...
    let form = {
        ...
        about_serice_title: document.getElementById('InputAboutServiceTitle').value,
        about_serice_1: document.getElementById('InputAboutService1').value,
        about_serice_img_1: bases64.InputAboutServiceImg1,
        about_serice_2: document.getElementById('InputAboutService2').value,
        about_serice_img_2: bases64.InputAboutServiceImg2,
        about_serice_3: document.getElementById('InputAboutService3').value,
        about_serice_img_3: bases64.InputAboutServiceImg3,
        about_serice_4: document.getElementById('InputAboutService4').value,
        about_serice_img_4: bases64.InputAboutServiceImg4,
        about_serice_5: document.getElementById('InputAboutService5').value,
        about_serice_img_5: bases64.InputAboutServiceImg5,
        about_serice_6: document.getElementById('InputAboutService6').value,
        about_serice_img_6: bases64.InputAboutServiceImg6,
