...
let bases64 = {
    ...
    InputBrandsImg7: null,
    InputBrandsImg8: null,
    InputBrandsImg9: null,
    InputBrandsImg10: null,
    InputBrandsImg11: null,
    InputBrandsImg12: null,
};
...
inputElementImg3.addEventListener(
    "change",
    load_image_about_img3_preview,
    false
);
async function load_image_about_img3_preview() {
    document.getElementById("ImageAboutImg3Preview").innerHTML =
        this.files[0].name;
    bases64.InputAboutImg3 = await toBase64(this.files[0]);
}
/*
const inputElementTestimonialsImg1 = document.getElementById(
    "InputTestimonialsImg1"
);
inputElementTestimonialsImg1.addEventListener(
    "change",
    load_image_testimonials_img1_preview,
    false
);
async function load_image_testimonials_img1_preview() {
    document.getElementById("InputTestimonialsImg1Preview").innerHTML =
        this.files[0].name;
    bases64.InputTestimonialsImg1 = await toBase64(this.files[0]);
}
const inputElementTestimonialsImg2 = document.getElementById(
    "InputTestimonialsImg2"
);
inputElementTestimonialsImg2.addEventListener(
    "change",
    load_image_testimonials_img2_preview,
    false
);
async function load_image_testimonials_img2_preview() {
    document.getElementById("InputTestimonialsImg2Preview").innerHTML =
        this.files[0].name;
...
async function load_image_frame_img_preview() {
    document.getElementById("ImageFrameImgPreview").innerHTML =
        this.files[0].name;
    bases64.InputFrameImg = await toBase64(this.files[0]);
}
const inputEmployeeImg1 = document.getElementById("InputEmployeeImg1");
inputEmployeeImg1.addEventListener(
    "change",
    load_image_employee_img1_preview,
    false
);
async function load_image_employee_img1_preview() {
    console.log("aaaaa");
    document.getElementById("InputEmployeeImg1Preview").innerHTML =
        this.files[0].name;
    bases64.InputEmployeeImg1 = await toBase64(this.files[0]);
}
const inputEmployeeImg2 = document.getElementById("InputEmployeeImg2");
inputEmployeeImg2.addEventListener(
    "change",
    load_image_employee_img2_preview,
    false
);
async function load_image_employee_img2_preview() {
    document.getElementById("InputEmployeeImg2Preview").innerHTML =
        this.files[0].name;
    bases64.InputEmployeeImg2 = await toBase64(this.files[0]);
}
const inputEmployeeImg3 = document.getElementById("InputEmployeeImg3");
inputEmployeeImg3.addEventListener(
    "change",
    load_image_employee_img3_preview,
    false
);
async function load_image_employee_img3_preview() {
    document.getElementById("InputEmployeeImg3Preview").innerHTML =
        this.files[0].name;
    bases64.InputEmployeeImg3 = await toBase64(this.files[0]);
}
const inputServiceImg1 = document.getElementById("InputServiceImg1");
inputServiceImg1.addEventListener(
    "change",
    load_image_service_img1_preview,
    false
);
async function load_image_service_img1_preview() {
    document.getElementById("ImageServiceImg1Preview").innerHTML =
        this.files[0].name;
    bases64.InputServiceImg1 = await toBase64(this.files[0]);
}
const inputServiceImg2 = document.getElementById("InputServiceImg2");
inputServiceImg2.addEventListener(
    "change",
    load_image_service_img2_preview,
    false
);
async function load_image_service_img2_preview() {
    document.getElementById("ImageServiceImg2Preview").innerHTML =
        this.files[0].name;
    bases64.InputServiceImg2 = await toBase64(this.files[0]);
}
const inputServiceImg3 = document.getElementById("InputServiceImg3");
inputServiceImg3.addEventListener(
    "change",
    load_image_service_img3_preview,
    false
);
async function load_image_service_img3_preview() {
    document.getElementById("ImageServiceImg3Preview").innerHTML =
        this.files[0].name;
    bases64.InputServiceImg3 = await toBase64(this.files[0]);
}
const inputBrandsImgBg = document.getElementById("InputBrandsImgBg");
inputBrandsImgBg.addEventListener(
    "change",
    load_image_employee_img4_preview,
    false
);
async function load_image_employee_img4_preview() {
    document.getElementById("InputBrandsImgBgPreview").innerHTML =
        this.files[0].name;
    bases64.InputBrandsImgBg = await toBase64(this.files[0]);
}
const inputBrandsImg1 = document.getElementById("InputBrandsImg1");
inputBrandsImg1.addEventListener(
    "change",
    load_image_employee_img5_preview,
    false
);
async function load_image_employee_img5_preview() {
    document.getElementById("InputBrandsImg1Preview").innerHTML =
        this.files[0].name;
    bases64.InputBrandsImg1 = await toBase64(this.files[0]);
}
const inputBrandsImg2 = document.getElementById("InputBrandsImg2");
inputBrandsImg2.addEventListener(
    "change",
    load_image_employee_img6_preview,
    false
);
async function load_image_employee_img6_preview() {
    document.getElementById("InputBrandsImg2Preview").innerHTML =
        this.files[0].name;
    bases64.InputBrandsImg2 = await toBase64(this.files[0]);
}
const inputBrandsImg3 = document.getElementById("InputBrandsImg3");
inputBrandsImg3.addEventListener(
    "change",
    load_image_employee_img7_preview,
    false
);
async function load_image_employee_img7_preview() {
    document.getElementById("InputBrandsImg3Preview").innerHTML =
        this.files[0].name;
    bases64.InputBrandsImg3 = await toBase64(this.files[0]);
}
const inputBrandsImg4 = document.getElementById("InputBrandsImg4");
inputBrandsImg4.addEventListener(
    "change",
    load_image_employee_img8_preview,
    false
);
async function load_image_employee_img8_preview() {
    document.getElementById("InputBrandsImg4Preview").innerHTML =
        this.files[0].name;
    bases64.InputBrandsImg4 = await toBase64(this.files[0]);
}
const inputBrandsImg5 = document.getElementById("InputBrandsImg5");
inputBrandsImg5.addEventListener(
    "change",
    load_image_employee_img9_preview,
    false
);
async function load_image_employee_img9_preview() {
    document.getElementById("InputBrandsImg5Preview").innerHTML =
        this.files[0].name;
    bases64.InputBrandsImg5 = await toBase64(this.files[0]);
}
const inputBrandsImg6 = document.getElementById("InputBrandsImg6");
inputBrandsImg6.addEventListener(
    "change",
    load_image_employee_img10_preview,
    false
);
async function load_image_employee_img10_preview() {
    document.getElementById("InputBrandsImg6Preview").innerHTML =
        this.files[0].name;
    bases64.InputBrandsImg6 = await toBase64(this.files[0]);
}
const inputBrandsImg7 = document.getElementById("InputBrandsImg7");
inputBrandsImg7.addEventListener("change",load_image_brand_img7_preview,false);
async function load_image_brand_img7_preview() {
    document.getElementById("InputBrandsImg7Preview").innerHTML = this.files[0].name;
    bases64.InputBrandsImg7 = await toBase64(this.files[0]);
}
const inputBrandsImg8 = document.getElementById("InputBrandsImg8");
inputBrandsImg8.addEventListener("change",load_image_brand_img8_preview,false);
async function load_image_brand_img8_preview() {
    document.getElementById("InputBrandsImg8Preview").innerHTML = this.files[0].name;
    bases64.InputBrandsImg8 = await toBase64(this.files[0]);
}
const inputBrandsImg9 = document.getElementById("InputBrandsImg9");
inputBrandsImg9.addEventListener("change",load_image_brand_img9_preview,false);
async function load_image_brand_img9_preview() {
    document.getElementById("InputBrandsImg9Preview").innerHTML = this.files[0].name;
    bases64.InputBrandsImg9 = await toBase64(this.files[0]);
}
const inputBrandsImg10 = document.getElementById("InputBrandsImg10");
inputBrandsImg10.addEventListener("change",load_image_brand_img10_preview,false);
async function load_image_brand_img10_preview() {
    document.getElementById("InputBrandsImg10Preview").innerHTML = this.files[0].name;
    bases64.InputBrandsImg10 = await toBase64(this.files[0]);
}
const inputBrandsImg11 = document.getElementById("InputBrandsImg11");
inputBrandsImg11.addEventListener("change",load_image_brand_img11_preview,false);
async function load_image_brand_img11_preview() {
    document.getElementById("InputBrandsImg11Preview").innerHTML = this.files[0].name;
    bases64.InputBrandsImg11 = await toBase64(this.files[0]);
}
const inputBrandsImg12 = document.getElementById("InputBrandsImg12");
inputBrandsImg12.addEventListener("change",load_image_brand_img12_preview,false);
async function load_image_brand_img12_preview() {
    document.getElementById("InputBrandsImg12Preview").innerHTML = this.files[0].name;
    bases64.InputBrandsImg12 = await toBase64(this.files[0]);
}
...
function saveIndexPage() {
    ...
    let form = {
        ...
        about_description: document.getElementById("InputAboutDescription")
            .value,
        about_description_eng: document.getElementById(
            "InputAboutDescriptionEng"
        ).value,
        about_img: bases64.InputAboutImg,
        about_num_1: document.getElementById("InputAboutNum1").value,
        about_description_1: document.getElementById("InputAboutDescription1")
            .value,
        about_description_1_eng: document.getElementById(
            "InputAboutDescription1Eng"
        ).value,
        about_num_2: document.getElementById("InputAboutNum2").value,
        about_description_2: document.getElementById("InputAboutDescription2")
            .value,
        about_description_2_eng: document.getElementById(
            "InputAboutDescription2Eng"
        ).value,
        about_num_3: document.getElementById("InputAboutNum3").value,
        about_description_3: document.getElementById("InputAboutDescription3")
            .value,
        about_description_3_eng: document.getElementById(
            "InputAboutDescription3Eng"
        ).value,
        ...
        service_title_eng: document.getElementById("InputServiceTitleEng")
            .value,
        service_title_1: document.getElementById("InputServiceTitle1").value,
        service_title_1_eng: document.getElementById("InputServiceTitle1Eng")
            .value,
        service_description_1: document.getElementById(
            "InputServiceDescription1"
        ).value,
        service_description_1_eng: document.getElementById(
            "InputServiceDescription1Eng"
        ).value,
        service_img_1: bases64.InputServiceImg1,
        service_title_2: document.getElementById("InputServiceTitle2").value,
        service_title_2_eng: document.getElementById("InputServiceTitle2Eng")
            .value,
        service_description_2: document.getElementById(
            "InputServiceDescription2"
        ).value,
        service_description_2_eng: document.getElementById(
            "InputServiceDescription2Eng"
        ).value,
        service_img_2: bases64.InputServiceImg2,
        service_title_3: document.getElementById("InputServiceTitle3").value,
        service_title_3_eng: document.getElementById("InputServiceTitle3Eng")
            .value,
        service_description_3: document.getElementById(
            "InputServiceDescription3"
        ).value,
        service_description_3_eng: document.getElementById(
            "InputServiceDescription3Eng"
        ).value,
        service_img_3: bases64.InputServiceImg3,

        portifolio_title: document.getElementById("InputPortifolioTitle").value,
        portifolio_title_eng: document.getElementById("InputPortifolioTitleEng")
            .value,
        ...
        frame_legend_1_eng: document.getElementById("InputFrameLegend1Eng")
            .value,
        frame_description_1: document.getElementById("InputFrameDescription1")
            .value,
        frame_description_1_eng: document.getElementById(
            "InputFrameDescription1Eng"
        ).value,
        ...
        frame_legend_2_eng: document.getElementById("InputFrameLegend2Eng")
            .value,
        frame_description_2: document.getElementById("InputFrameDescription2")
            .value,
        frame_description_2_eng: document.getElementById(
            "InputFrameDescription2Eng"
        ).value,

        about_us_title: document.getElementById("InputAboutUsTitle").value,
        about_us_title_eng: document.getElementById("InputAboutUsTitleEng")
            .value,
        about_us_description: document.getElementById("InputAboutUsDescription")
            .value,
        about_us_description_eng: document.getElementById(
            "InputAboutUsDescriptionEng"
        ).value,

        testimonials_title: document.getElementById("InputTestimonialsTitle")
            .value,
        testimonials_title_eng: document.getElementById(
            "InputTestimonialsTitleEng"
        ).value,
        testimonials_description: document.getElementById(
            "InputTestimonialsDescription"
        ).value,
        testimonials_description_eng: document.getElementById(
            "InputTestimonialsDescriptionEng"
        ).value,
        /*
        ...
        */
        ...
        employee_work_1_eng: document.getElementById("InputEmployeeWork1Eng")
            .value,
        employee_img_1: bases64.InputEmployeeImg1,
        /*
        employee_url_facebook_1: document.getElementById(
            "InputEmployeeUrlFacebook1"
        ).value,
        employee_url_instagram_1: document.getElementById(
            "InputEmployeeUrlInstagram1"
        ).value,
        employee_url_twitter_1: document.getElementById(
        ...
        */
        ...
        employee_work_2_eng: document.getElementById("InputEmployeeWork2Eng")
            .value,
        employee_img_2: bases64.InputEmployeeImg2,
        /*
        employee_url_facebook_2: document.getElementById(
            "InputEmployeeUrlFacebook2"
        ).value,
        employee_url_instagram_2: document.getElementById(
            "InputEmployeeUrlInstagram2"
        ).value,
        employee_url_twitter_2: document.getElementById(
        ...
        */
        ...
        employee_work_3_eng: document.getElementById("InputEmployeeWork3Eng")
            .value,
        employee_img_3: bases64.InputEmployeeImg3,
        /*
        employee_url_facebook_3: document.getElementById(
            "InputEmployeeUrlFacebook3"
        ).value,
        employee_url_instagram_3: document.getElementById(
            "InputEmployeeUrlInstagram3"
        ).value,
        employee_url_twitter_3: document.getElementById(
        ...
        */
        ...
        brands_img_7: bases64.InputBrandsImg7,
        brands_img_8: bases64.InputBrandsImg8,
        brands_img_9: bases64.InputBrandsImg9,
        brands_img_10: bases64.InputBrandsImg10,
        brands_img_11: bases64.InputBrandsImg11,
        brands_img_12: bases64.InputBrandsImg12,
        ...
        sign_description_eng: document.getElementById("InputSignDescriptionEng")
            .value,
        ...
        social_url_facebook: document.getElementById("InputSocialFacebook")
            .value,
        social_url_instagram: document.getElementById("InputSocialInstagram")
            .value,
        social_url_twitter: document.getElementById("InputSocialTwitter").value,
        social_url_linkedin: document.getElementById("InputSocialLinkedin")
            .value,

        contact_telephone: document.getElementById("InputContactTelephone")
            .value,
        contact_cellphone: document.getElementById("InputContactCellphone")
            .value,
        contact_email: document.getElementById("InputContactEmail").value,

        navigation_title_1: document.getElementById("InputNavigationTitle1")
            .value,
        navigation_title_1_eng: document.getElementById(
            "InputNavigationTitle1Eng"
        ).value,
        navigation_url_1: document.getElementById("InputNavigationUrl1").value,
        navigation_title_2: document.getElementById("InputNavigationTitle2")
            .value,
        navigation_title_2_eng: document.getElementById(
            "InputNavigationTitle2Eng"
        ).value,
        navigation_url_2: document.getElementById("InputNavigationUrl2").value,
        navigation_title_3: document.getElementById("InputNavigationTitle3")
            .value,
        navigation_title_3_eng: document.getElementById(
            "InputNavigationTitle3Eng"
        ).value,
        navigation_url_3: document.getElementById("InputNavigationUrl3").value,
        navigation_title_4: document.getElementById("InputNavigationTitle4")
            .value,
        navigation_title_4_eng: document.getElementById(
            "InputNavigationTitle4Eng"
        ).value,
        navigation_url_4: document.getElementById("InputNavigationUrl4").value,
    };

    apiPostBearer(
        GLOBAL_URL_API + "save-index-page",
        form,
